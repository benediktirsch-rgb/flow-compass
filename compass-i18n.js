/* ============================================================================
   ...
   Änderung wieder. Deshalb derselbe Weg wie auf der Vishnu-Website
   ...
   überschriften, Mein Board, Kompass, Kennzahlen-Blüten, Dialoge, John, Menüs,
   Level und Abzeichen, Tastenhilfe.

   WAS BEWUSST DEUTSCH BLEIBT: **deine Inhalte.** Jira-Titel, Trello-Karten,
   Rückfragen, „Diese Woche“, Projektzeilen, Checkin-Antworten, Johns Antworten
...
(function () {
  ...
  const W = {
    ...
    /* ---- Kopf, Rahmen, Zugang ------------------------------------------- */
    'Vishnu Flow Compass · Bene': ['Vishnu Flow Compass · Bene', 'بوصلة فيشنو للتدفّق · بينه'],
    'Know what matters next': ['Know what matters next', 'اعرف ما يهمّ تاليًا'],
    'Vishnu Flow Compass · Know what matters next': ['Vishnu Flow Compass · Know what matters next', 'بوصلة فيشنو للتدفّق · اعرف ما يهمّ تاليًا'],
    'Ein Login für Compass und Vishnu Cockpit: dein Name (wie in Jira) und das Team-Passwort. Gilt 30 Tage auf diesem Gerät.':
      ['One login for Compass and the Vishnu Cockpit: your name (as in Jira) and the team password. Valid for 30 days on this device.',
       'تسجيل دخول واحد للبوصلة ولقُمرة فيشنو: اسمك (كما في Jira) وكلمة مرور الفريق. صالح 30 يومًا على هذا الجهاز.'],
    ...
    'Vishnu Flow Compass · lokal, nicht veröffentlicht · gebaut mit Claude':
      ['Vishnu Flow Compass · local, not published · built with Claude', 'بوصلة فيشنو للتدفّق · محلّية، غير منشورة · بُنيت مع كلود'],
    ...
    'Feste Phase bleibt, bis du wieder „Automatisch“ wählst — gut zum Ausprobieren am Abend. Das eingebettete Vishnu Cockpit übernimmt das Farbschema.':
      ['A fixed phase stays until you pick “Automatic” again — handy for trying things out in the evening. The embedded Vishnu Cockpit follows the colour scheme.',
       'تبقى المرحلة الثابتة حتى تختار «تلقائي» مجددًا — مفيد للتجربة مساءً. وقُمرة فيشنو المدمجة تتبع نظام الألوان.'],
    ...
    'weiter': ['go on', 'تابع'],
    'später': ['later', 'لاحقًا'],
    '✎ Eigene Antwort': ['✎ Own answer', '✎ إجابتي الخاصة'],
    'Eigene Antwort': ['Own answer', 'إجابتي الخاصة'],
    'Antwort senden': ['Send answer', 'أرسل الإجابة'],
    'Deine Antwort in eigenen Worten …': ['Your answer in your own words …', 'إجابتك بكلماتك الخاصة …'],
    '✓ Ja':['✓ Yes', '✓ نعم'],
    '✗ Nein': ['✗ No', '✗ لا'],
    '↗ Link': ['↗ Link', '↗ رابط'],
    '💬 Fragen': ['💬 Ask', '💬 اسأل'],
    '💬 An Claude senden': ['💬 Send to Claude', '💬 أرسل إلى كلود'],
    '🧠 John fragen': ['🧠 Ask John', '🧠 اسأل جون'],
    'Alles verarbeitet': ['Everything processed', 'تمت معالجة كل شيء'],
    'nichts wartet mehr': ['nothing left waiting', 'لا شيء ينتظر'],
    'Heute verarbeitet:': ['Processed today:', 'تمت معالجته اليوم:'],
    'fertig': ['done', 'تم'],
    ...
    'Wochenende: aus Trello „Bene privat“ und Vaikuntha. Antippen streicht eine Sache, fehlt etwas: hier notieren.':
      ['Weekend: from Trello “Bene privat” and Vaikuntha. Tap to strike something, if anything is missing: note it here.',
       'عطلة نهاية الأسبوع: من Trello „Bene privat“ ومن فايكونتا. انقر لشطب أمر، وإن نقص شيء فدوّنه هنا.'],
    'Nichts Digitales für heute — Familie, Sport, Erholung.': ['Nothing digital for today — family, sport, rest.', 'لا شيء رقمي لليوم — عائلة ورياضة وراحة.'],
    'Vishnu und Porsche ruhen bis Montag — {1} Vorgänge in Arbeit warten dort.': ['Vishnu and Porsche rest until Monday — {1} items in progress are waiting there.', 'فيشنو وبورشه في راحة حتى الاثنين — {1} بنود قيد العمل تنتظر هناك.'],
    'Vishnu und Porsche ruhen bis Montag.': ['Vishnu and Porsche rest until Monday.', 'فيشنو وبورشه في راحة حتى الاثنين.'],
    'Trello und Jira haben nicht geantwortet — das ist die Handliste „Privat“, nicht der heutige Stand.': ['Trello and Jira did not answer — this is the hand-kept “Private” list, not today’s state.', 'لم يُجب Trello ولا Jira — هذه القائمة اليدوية „خاص“، لا حالة اليوم.'],
    ...
    'Postfach-Rückstand (live über john-server, GET /api/postfach — gefüllt von der Aufgabe „compass-postfach“)':
      ['Inbox backlog (live via the John server, GET /api/postfach — filled by the “compass-postfach” task)',
       'متراكم البريد (مباشر عبر خادم جون، GET /api/postfach — تملؤه مهمة «compass-postfach»)'],
    ...
    'Rückfragen mit John': ['Questions with John', 'أسئلة مع جون'],
    ...
    /* ---- Kontext-Leiste -------------------------------------------------- */
    'Alle': ['All', 'الكل'],
    'Vishnu Artists': ['Vishnu Artists', 'فيشنو أرتيستس'],
    'Vaikuntha': ['Vaikuntha', 'فايكونثا'],
    'Privat': ['Private', 'شخصي'],
    'privat': ['private', 'شخصي'],
    ...
    'Nur Vishnu Artists — Strg+Klick: dazunehmen': ['Vishnu Artists only — Ctrl+click to add', 'فيشنو أرتيستس فقط — Ctrl+نقر للإضافة'],
    'Nur Vaikuntha — Strg+Klick: dazunehmen': ['Vaikuntha only — Ctrl+click to add', 'فايكونثا فقط — Ctrl+نقر للإضافة'],
    ...
    'Vishnu Kanban': ['Vishnu kanban', 'كانبان فيشنو'],
    ...
    'Finance, Vaikuntha, Neukunden, nächste Schritte': ['Finance, Vaikuntha, new clients, next steps', 'المالية وفايكونثا والعملاء الجدد والخطوات التالية'],
    ...
    'Jira (Vishnu)': ['Jira (Vishnu)', 'Jira (فيشنو)'],
    ...
    'Entscheidung heute': ['decision today', 'قرار اليوم'],
    '{1} Entscheidungen heute': ['{1} decisions today', '{1} قرارات اليوم'],
    'Morgenboard · heute': ['Morning board · today', 'لوحة الصباح · اليوم'],
    'Abendboard · heute': ['Evening board · today', 'لوحة المساء · اليوم'],
    'Abendboard · gestern Abend': ['Evening board · last night', 'لوحة المساء · ليلة أمس'],
    'Dein Abendboard von gestern liegt bereit': ['Your evening board from yesterday is ready', 'لوحة مسائك من الأمس جاهزة'],
    'Abendboard öffnen': ['Open evening board', 'افتح لوحة المساء'],
    ...
    /* ---- Board einrichten + Liste aufs Board (14.09.2026) ------------------ */
    '⚙ Einrichten': ['⚙ Set up', '⚙ إعداد'],
    'Board einrichten': ['Set up the board', 'إعداد اللوحة'],
    'Board einrichten — Quellen, Jira-Projekte und Rollen, Status → Spalte, Farben': ['Set up the board — sources, Jira projects and roles, status → column, colours', 'إعداد اللوحة — المصادر، مشاريع Jira والأدوار، الحالة ← العمود، الألوان'],
    'Quellen, Jira-Projekte und Rollen, Status → Spalte, Farben': ['Sources, Jira projects and roles, status → column, colours', 'المصادر، مشاريع Jira والأدوار، الحالة ← العمود، الألوان'],
    'Welche Quellen auf dein Board dürfen, welche Jira-Projekte und Rollen, wie ein Status auf die Spalten fällt, welche Farbe eine Quelle trägt. Jede Änderung wirkt sofort und gilt in jeder Fassung deines Compass.':
      ['Which sources may reach your board, which Jira projects and roles, how a status lands on the columns, which colour a source carries. Every change takes effect at once and applies in every copy of your Compass.',
       'أيّ مصادر تصل إلى لوحتك، وأيّ مشاريع Jira وأدوار، وكيف تقع الحالة على الأعمدة، وأيّ لون يحمله المصدر. كل تغيير يسري فورًا وفي كل نسخة من بوصلتك.'],
    'Quellen': ['Sources', 'المصادر'],
    'an/aus · Farbe = linker Kartenrand': ['on/off · colour = left card edge', 'تشغيل/إيقاف · اللون = حافة البطاقة اليسرى'],
    'Rollen und Projekte': ['Roles and projects', 'الأدوار والمشاريع'],
    'mir zugewiesen': ['assigned to me', 'مُسندة إليّ'],
    'von mir gemeldet': ['reported by me', 'أبلغتُ عنها'],
    'Gemeldetes zählt ins WIP': ['Reported counts toward WIP', 'المُبلَّغ يُحتسب في العمل الجاري'],
    'Vorgänge, die dir zugewiesen sind': ['Issues assigned to you', 'المهام المُسندة إليك'],
    'Vorgänge, die du gemeldet hast und jemand anderes bearbeitet — auf dem Board gestrichelt, mit 📣 und Bearbeiter': ['Issues you reported that someone else works on — dashed on the board, with 📣 and the assignee', 'مهام أبلغتَ عنها ويعمل عليها شخص آخر — متقطّعة على اللوحة مع 📣 واسم المنفّذ'],
    'Standard: Gemeldetes zählt nicht ins WIP-Limit — es ist nicht deine Arbeit': ['Default: reported issues do not count toward the WIP limit — they are not your work', 'الافتراضي: المُبلَّغ لا يُحتسب في حدّ العمل الجاري — ليس عملك'],
    'Neue Projekte sind automatisch an. Ein Projekt ausschalten nimmt seine Vorgänge vom Board, nicht aus Jira. Gemeldete Vorgänge erscheinen gestrichelt mit 📣 und dem Bearbeiter und zählen nicht ins WIP-Limit — es ist ihre Arbeit, nicht deine.':
      ['New projects are on automatically. Switching a project off removes its issues from the board, not from Jira. Reported issues appear dashed with 📣 and the assignee and do not count toward the WIP limit — it is their work, not yours.',
       'المشاريع الجديدة تعمل تلقائيًا. إيقاف مشروع يزيل مهامه من اللوحة لا من Jira. المهام المُبلَّغ عنها تظهر متقطّعة مع 📣 والمنفّذ ولا تُحتسب في حدّ العمل الجاري — إنها عملهم لا عملك.'],
    'Jira ist als Quelle ausgeschaltet.': ['Jira is switched off as a source.', 'Jira موقوف كمصدر.'],
    'Keine Projekte gefunden.': ['No projects found.', 'لم يُعثر على مشاريع.'],
    'Status → Spalte': ['Status → column', 'الحالة ← العمود'],
    '„automatisch“ = Heuristik; „ausblenden“ nimmt den Status vom Board': ['“automatic” = heuristic; “hide” removes the status from the board', '«تلقائي» = استدلال؛ «إخفاء» يزيل الحالة من اللوحة'],
    'Status / Liste': ['Status / list', 'الحالة / القائمة'],
    'Spalte auf Mein Board': ['Column on My Board', 'العمود على لوحتي'],
    'ausblenden': ['hide', 'إخفاء'],
    'Noch keine Status oder Listen geladen — sobald Jira und Trello da sind, stehen sie hier.': ['No statuses or lists loaded yet — once Jira and Trello are in, they appear here.', 'لم تُحمَّل حالات أو قوائم بعد — ستظهر هنا حالما تصل Jira وTrello.'],
    'Spalten': ['Columns', 'الأعمدة'],
    'WIP-Limit, Alterung, eigene Titel': ['WIP limit, ageing, your own titles', 'حدّ العمل الجاري، التقادم، عناوينك'],
    'WIP-Limit': ['WIP limit', 'حدّ العمل الجاري'],
    'gelb ab': ['yellow from', 'أصفر من'],
    'rot ab': ['red from', 'أحمر من'],
    'Ab so vielen Tagen in Arbeit wird die Karte gelb': ['After this many days in progress the card turns yellow', 'بعد هذا العدد من الأيام قيد العمل تصبح البطاقة صفراء'],
    'Ab so vielen Tagen in Arbeit wird die Karte rot': ['After this many days in progress the card turns red', 'بعد هذا العدد من الأيام قيد العمل تصبح البطاقة حمراء'],
    '↺ Zurücksetzen': ['↺ Reset', '↺ إعادة الضبط'],
    'Alle Einstellungen des Boards auf den Standard zurücksetzen': ['Reset all board settings to the default', 'إعادة كل إعدادات اللوحة إلى الافتراضي'],
    'Standard': ['Default', 'الافتراضي'],
    'Farbe entfernen': ['Remove colour', 'إزالة اللون'],
    'Farbe ändern — linker Rand der Karten': ['Change colour — left edge of the cards', 'تغيير اللون — الحافة اليسرى للبطاقات'],
    'Farbe geben — linker Rand der Karten': ['Give a colour — left edge of the cards', 'إعطاء لون — الحافة اليسرى للبطاقات'],
    'ohne Bearbeiter': ['no assignee', 'بدون منفّذ'],
    '📝 Liste aufs Board': ['📝 List onto the board', '📝 قائمة إلى اللوحة'],
    'Liste aufs Board': ['List onto the board', 'قائمة إلى اللوحة'],
    'Getippte Liste, eingefügter Text oder Foto eines Zettels — jede Zeile wird eine Karte': ['A typed list, pasted text or a photo of a note — every line becomes a card', 'قائمة مكتوبة أو نص ملصق أو صورة ورقة — كل سطر يصبح بطاقة'],
    'Tipp eine Liste ein, füg sie ein oder fotografiere den Zettel — jede Zeile wird eine Karte. Du siehst die Karten vorher und streichst, was nicht mit soll.':
      ['Type a list, paste it or photograph the note — every line becomes a card. You see the cards first and strike what should not come along.',
       'اكتب قائمة أو الصقها أو صوّر الورقة — كل سطر يصبح بطاقة. ترى البطاقات أولًا وتشطب ما لا تريده.'],
    '📷 Foto lesen': ['📷 Read a photo', '📷 قراءة صورة'],
    'Foto einer handschriftlichen Liste — am Handy direkt aufnehmen; die KI liest sie': ['A photo of a handwritten list — take it right on the phone; the AI reads it', 'صورة قائمة مكتوبة بخط اليد — التقطها من الهاتف مباشرة؛ الذكاء الاصطناعي يقرؤها'],
    '✨ Mit KI ordnen': ['✨ Sort with AI', '✨ ترتيب بالذكاء الاصطناعي'],
    'Den getippten Text von der KI ordnen lassen — Überschriften, Daten, Erledigtes, unsaubere Zeilen': ['Let the AI sort the typed text — headings, dates, done items, messy lines', 'دع الذكاء الاصطناعي يرتّب النص — العناوين والتواريخ والمنجَز والأسطر غير المرتّبة'],
    'Wohin': ['Where to', 'إلى أين'],
    'Jira-Projekt · Typ Task': ['Jira project · type Task', 'مشروع Jira · النوع مهمة'],
    'Spalte': ['Column', 'العمود'],
    'wie erkannt (✓ → Fertig, „wartet“ → Wartet, sonst Bereit)': ['as recognised (✓ → done, “waiting” → waiting, otherwise ready)', 'كما تُعرَف (✓ ← منجز، «ينتظر» ← ينتظر، وإلا جاهز)'],
    'Karten anlegen': ['Create cards', 'إنشاء البطاقات'],
    'Karte anlegen?': ['Create this card?', 'إنشاء هذه البطاقة؟'],
    'alle': ['all', 'الكل'],
    'keine': ['none', 'لا شيء'],
    'Erst Text eintippen oder einfügen.': ['Type or paste text first.', 'اكتب النص أو الصقه أولًا.'],
    'Schnellkarten nur im Compass — ohne Server, ohne Ticket. Später per ▶ ziehen oder in Trello/Jira neu anlegen.': ['Quick cards in the Compass only — no server, no ticket. Pull later with ▶ or recreate in Trello/Jira.', 'بطاقات سريعة في البوصلة فقط — بلا خادم وبلا تذكرة. اسحبها لاحقًا بـ ▶ أو أنشئها في Trello/Jira.'],
    'Je Zeile ein Task, dir zugewiesen; Notiz und Fälligkeit stehen in der Beschreibung.': ['One task per line, assigned to you; note and due date go into the description.', 'مهمة لكل سطر مُسندة إليك؛ الملاحظة والموعد في الوصف.'],
    'Je Zeile eine Trello-Karte in der Liste, die zur Spalte passt (Token braucht scope=read,write).': ['One Trello card per line in the list that matches the column (token needs scope=read,write).', 'بطاقة Trello لكل سطر في القائمة المطابقة للعمود (يحتاج الرمز إلى scope=read,write).'],
    ...
    'Trello nicht geladen — John-Server läuft?': ['Trello not loaded — is the John server running?', 'لم يُحمَّل تريلو — هل خادم جون يعمل؟'],
    ...
    'John-Server nicht erreichbar — Spalte nur im Compass gemerkt.': ['John server not reachable — the column is remembered in the Compass only.', 'خادم جون غير متاح — العمود محفوظ في البوصلة فقط.'],
    ...
    /* Der Trichter (05.09.). Übersetzt sind die Bausteine der Oberfläche: Bahnen, Knöpfe,
       Kachel-Beschriftungen, die leeren und die blinden Zustände. NICHT übersetzt sind die
       Zeilen, die Zahlen und Namen mischen („35/40 im Kollektiv · …“) — dieselbe Regel wie
       bei Jira-Titeln: was Inhalt ist, bleibt deutsch, statt halb übersetzt zu werden. */
    'Menschen im Trichter': ['People in the funnel', 'أشخاص في المسار'],
    'warten': ['waiting', 'ينتظرون'],
    '{1} warten': ['{1} waiting', '{1} ينتظرون'],
    '{1} wartet': ['{1} waiting', '{1} ينتظر'],
    '{1} gefunden · teilweise blind': ['{1} found · partly blind', '{1} موجود · رؤية ناقصة'],
    'seit gestern': ['since yesterday', 'منذ أمس'],
    'seit {1} Tagen': ['for {1} days', 'منذ {1} أيام'],
    'Menschen warten auf dich': ['People are waiting for you', 'أشخاص ينتظرونك'],
    'warten auf dich': ['waiting for you', 'ينتظرونك'],
    'wartet auf dich': ['waiting for you', 'ينتظرك'],
    'niemand wartet': ['nobody waiting', 'لا أحد ينتظر'],
    'im Kollektiv': ['in the collective', 'في الجماعة'],
    'verfügbar': ['available', 'متاح'],
    'im Einsatz': ['on assignment', 'في مهمة'],
    'Ankommen': ['Arriving', 'الوصول'],
    'Ins Kollektiv': ['Into the collective', 'إلى الجماعة'],
    'Zum Kunden': ['To the client', 'إلى العميل'],
    'Tore des Kollektivs': ['Gates of the collective', 'بوابات الجماعة'],
    'Teilweise blind': ['Partly blind', 'رؤية ناقصة'],
    'im Portal ↗': ['open in portal ↗', 'في البوابة ↗'],
    'Absage': ['Decline', 'رفض'],
    /* Die Stufen aus f/portal-lib.php — sie stehen auf den Knöpfen, also Oberfläche. */
    'Profil eingegangen': ['Profile received', 'وصل الملف'],
    'Kennenlerngespräch': ['Intro call', 'مقابلة تعارف'],
    'Profil & Unterlagen geprüft': ['Profile & documents checked', 'مراجعة الملف والوثائق'],
    'Kooperationsvertrag': ['Cooperation agreement', 'اتفاقية تعاون'],
    'Im Kollektiv': ['In the collective', 'في الجماعة'],
    'Nicht zustande gekommen': ['Did not happen', 'لم يتم'],
    'Angebot vorgelegt': ['Offer presented', 'قُدّم العرض'],
    'Profil eingereicht': ['Profile submitted', 'أُرسل الملف'],
    'Beim Kunden vorgestellt': ['Presented to client', 'عُرض على العميل'],
    'Gespräch vereinbart': ['Interview scheduled', 'حُدّد موعد المقابلة'],
    'Angebot liegt vor': ['Offer on the table', 'العرض متاح'],
    'Im Einsatz': ['On assignment', 'في مهمة'],
    'Einsatz abgeschlossen': ['Assignment completed', 'انتهت المهمة'],
    'Registrierung wartet auf Freigabe': ['Registration awaiting approval', 'تسجيل بانتظار الموافقة'],
    ...
    'Aufrufe vaikuntha.eu': ['Page views vaikuntha.eu', 'زيارات vaikuntha.eu'],
    'Aufrufe Vishnu Artists': ['Page views Vishnu Artists', 'زيارات فيشنو أرتيستس'],
    ...
    'Vaikuntha {1} gestern': ['Vaikuntha {1} yesterday', 'فايكونتا {1} أمس'],
    'Vishnu {1} am {2}.': ['Vishnu {1} on {2}.', 'فيشنو {1} في {2}.'],
    ...
    'John trägt die Summary vor (Sprachausgabe)': ['John reads the summary aloud (speech output)', 'يقرأ جون الملخّص بصوت مسموع'],
    'Neu formulieren lassen': ['Ask for a rewrite', 'اطلب صياغة جديدة'],
    'Im Chat mit John weiterdenken': ['Think it through with John in the chat', 'واصل التفكير مع جون في المحادثة'],
    'John · Management-Summary': ['John · management summary', 'جون · ملخّص إداري'],
    'John ist offline — starte john-server.cmd, dann kommt die Summary hier hin.':
      ['John is offline — start john-server.cmd and the summary will appear here.', 'جون غير متصل — شغّل john-server.cmd ليظهر الملخّص هنا.'],
    ...
    'XP, Streak, Board-Zuordnung, John-Verlauf und Einstellungen als Text kopieren — z. B. um sie in den Live-Compass zu übernehmen':
      ['Copy XP, streak, board assignments, John history and settings as text — e.g. to move them into the live Compass',
       'انسخ النقاط والسلسلة وتوزيع اللوح وسجل جون والإعدادات كنص — لنقلها إلى البوصلة المباشرة مثلًا'],
    ...
    /* ---- John ------------------------------------------------------------ */
    'John · Coach': ['John · coach', 'جون · مدرّب'],
    'John — Coach & Sparringspartner': ['John — coach and sparring partner', 'جون — مدرّب وشريك نقاش'],
    'Karriere-Coach · Claude Fable 5': ['Career coach · Claude Fable 5', 'مدرّب مهني · Claude Fable 5'],
    'Verbinde …': ['Connecting …', 'جارٍ الاتصال …'],
    'Senden': ['Send', 'إرسال'],
    'Schreib John … (Enter sendet, Shift+Enter = Zeile)': ['Write to John … (Enter sends, Shift+Enter for a new line)', 'اكتب إلى جون … (Enter للإرسال، Shift+Enter لسطر جديد)'],
    'Heute?': ['Today?', 'اليوم؟'],
    ...
    'John will mit dir spielen': ['John wants to play', 'جون يريد أن يلعب'],
    'John fordert dich heraus': ['John is challenging you', 'جون يتحدّاك'],
    'John sieht ein Risiko': ['John sees a risk', 'جون يرى خطرًا'],
    'John fasst dir die Lage zusammen': ['John sums up the situation for you', 'جون يلخّص لك الوضع'],
    'John will besser mit dir arbeiten': ['John wants to work better with you', 'جون يريد عملًا أفضل معك'],
    ...
    'Mit John besprechen': ['Discuss with John', 'ناقش مع جون'],
    'John ist offline — starte john-server.cmd im Cockpit-Ordner (öffnet http://localhost:8787/dashboard.html).':
      ['John is offline — start john-server.cmd in the cockpit folder (opens http://localhost:8787/dashboard.html).',
       'جون غير متصل — شغّل john-server.cmd في مجلّد القُمرة (يفتح http://localhost:8787/dashboard.html).'],

    /* ---- Server- und Statuszeilen ---------------------------------------- */
    'John-Server nicht erreichbar': ['John server not reachable', 'خادم جون غير متاح'],
    ...
    'Hole das Board vom Vishnu Cockpit …': ['Fetching the board from the Vishnu Cockpit …', 'جارٍ جلب اللوح من قُمرة فيشنو …'],
    ...
    'Hole Listen und Karten vom John-Server …': ['Fetching lists and cards from the John server …', 'جارٍ جلب القوائم والبطاقات من خادم جون …'],
    ...
    'Weitere Konten verbinden: claude.ai → Einstellungen → Connectors (Gmail/Outlook) — muss Bene selbst autorisieren.':
      ['Connect more accounts: claude.ai → settings → connectors (Gmail/Outlook) — Bene has to authorise this himself.',
       'لربط حسابات أخرى: claude.ai ← الإعدادات ← الموصلات (Gmail/Outlook) — على بينه منح الإذن بنفسه.'],
    ...
    'Vishnu Artists öffnen': ['open Vishnu Artists', 'افتح فيشنو أرتيستس'],
    'Vaikuntha öffnen': ['open Vaikuntha', 'افتح فايكونثا'],
    ...
    'sonst Porsche-Team (aggregated.json)': ['otherwise the Porsche team (aggregated.json)', 'وإلا فريق بورشه (aggregated.json)'],
    'Porsche aggregated.json (live)': ['Porsche aggregated.json (live)', 'Porsche aggregated.json (مباشر)'],
    'Claude Code (live über john-server)': ['Claude Code (live via the John server)', 'Claude Code (مباشر عبر خادم جون)'],
    'Claude Code (~/.claude/projects, live über john-server)': ['Claude Code (~/.claude/projects, live via the John server)', 'Claude Code (~/.claude/projects، مباشر عبر خادم جون)'],
    'Google-Kalender über die geheime iCal-Adresse (live über john-server)':
      ['Google Calendar via the secret iCal address (live via the John server)', 'تقويم غوغل عبر عنوان iCal السرّي (مباشر عبر خادم جون)'],
    'Seiten-Wächter (live über john-server, GET /api/wacht)': ['Site watchdog (live via the John server, GET /api/wacht)', 'حارس المواقع (مباشر عبر خادم جون، GET /api/wacht)'],
    ...
    'Sicherungs-Wächter (live über john-server, GET /api/sicherung)': ['Backup watchdog (live via the John server, GET /api/sicherung)', 'حارس النسخ الاحتياطي (مباشر عبر خادم جون، GET /api/sicherung)'],
    ...
    'Arbeit mit Claude: john-server nicht erreichbar — Transkripte werden dann nicht gezählt':
      ['Working with Claude: the John server is not reachable — transcripts are not counted then',
       'العمل مع كلود: خادم جون غير متاح — لا تُحتسب السجلات حينها'],
    'Quellen: Claude-Code-Transkripte (live) · Jira aus kennzahlen-data.js · Porsche-Cockpit live · Kalender – · Traffic aus dem Tages-Snapshot · Umsatz und Energie trägst du selbst ein · Rhythmus lokal. „–“ heißt: nicht gemessen, nicht erfunden.':
      ['Sources: Claude Code transcripts (live) · Jira from kennzahlen-data.js · Porsche cockpit live · calendar – · traffic from the daily snapshot · revenue and energy you enter yourself · rhythm local. “–” means: not measured, not invented.',
       'المصادر: سجلات Claude Code (مباشرة) · Jira من kennzahlen-data.js · قُمرة بورشه مباشرة · التقويم – · الزيارات من اللقطة اليومية · الإيراد والطاقة تُدخلهما بنفسك · الإيقاع محلّي. و«–» تعني: غير مقيس، لا مُختلق.'],
    ...
    'Kennzahlen · Vaikuntha & Vishnu': ['Metrics · Vaikuntha & Vishnu', 'المؤشرات · فايكونثا وفيشنو'],
    ...
    'Rückruf-Anfragen (Vishnu)': ['Call-back requests (Vishnu)', 'طلبات معاودة الاتصال (فيشنو)'],
    'Melden': ['Report', 'إبلاغ'],
    ...
    'Vishnu-Website (/f/)': ['Vishnu website (/f/)', 'موقع فيشنو (/f/)'],
    ...
    'Der Vaikuntha-Zähler summiert bisher nur pro Tag, die Vishnu-Seite misst gar nicht.':
      ['The Vaikuntha counter only totals per day so far, and the Vishnu site does not measure at all.',
       'عدّاد فايكونثا يجمع يوميًا فقط حتى الآن، وموقع فيشنو لا يقيس إطلاقًا.'],
    ...
    'Vaikuntha — Mitglieder:': ['Vaikuntha — members:', 'فايكونثا — الأعضاء:'],
    'Vishnu — Rückruf-Anfragen:': ['Vishnu — call-back requests:', 'فيشنو — طلبات معاودة الاتصال:'],
    ...
    /* ---- Verkaufs-Demo (31.08.2026, Rückfrage `compass-demo-sprachen`) --------
       Der Produkt-Build formuliert für die Demo eigene Sätze (aus „John“ wird „Coach“,
       aus „Rückfragen von Claude“ „Offene Entscheidungen“) und bringt eigene Beispieldaten
       mit. Diese Texte treffen keinen Schlüssel der Quelle — hier stehen sie. In Benes
    ...
    'Analytics-Plugin auf vaikuntha.eu (live über john-server, GET /api/vaikuntha) · ohne Server der Tages-Snapshot aus kennzahlen-data.js': ['Analytics plugin on the project site (live via the server, GET /api/vaikuntha) · without a server the daily snapshot from kennzahlen-data.js', 'إضافة التحليلات على موقع المشروع (مباشرةً عبر الخادم، GET /api/vaikuntha) · وبلا خادم تُستخدم اللقطة اليومية من kennzahlen-data.js'],
    'Analytics-Plugin auf vaikuntha.eu (live über john-server)': ['Analytics plugin on the project site (live via the server)', 'إضافة التحليلات على موقع المشروع (مباشرةً عبر الخادم)'],
    'Analytics-Plugin auf vaikuntha.eu (live über john-server) — Kontakte, die Mitglied geworden sind': ['Analytics plugin on the project site (live via the server) — contacts who became members', 'إضافة التحليلات على موقع المشروع (مباشرةً عبر الخادم) — جهات الاتصال التي صارت أعضاء'],
  ...
  /* Platzhalter: Zahlen — und auf zweiter Stufe auch Zitiertes in „…“ — werden zu
     {1}, {2} …, damit ein Eintrag auf jede Ausprägung passt:
       ...
       "Aus „Vishnu Artists“. Reicht…" → "Aus „{1}“. Reicht…"
  ...
  /* Zusammengesetzte Zeilen. Der Compass baut viele Texte aus Bausteinen:
     „Ordnung — WIP 3/3 — das Board ist geordnet.“, „offene Tickets — Vaikuntha
  ...
  function attrEl(el) {
    ...
    /* Johns Schnellfragen sind der Text, der an John geht — die dürfen mit. */
