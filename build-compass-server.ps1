...
$dateien = @('compass-server.ps1','coach-tools.ps1','coach-mcp.ps1','firmen-daten.ps1','gedaechtnis.ps1','avatare.ps1','avatar-master-v1.json','avatar-guides.json','ausgabe.ps1','systembild.ps1','compass-server.json','start-compass-server.cmd',
