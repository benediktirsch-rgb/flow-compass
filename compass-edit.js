/* ==========================================================================
   Flow Compass — Editier-Modus fuers Layout (24.08.2026, Benes Wunsch:
...
/* Was ab Werk oben andockt: Blumen, Kompass und John. Kompass + John sind Benes
...
var STD_OBEN=[BLUMEN,'🧭 Kompass','🤵 John'];
...
var STD_SPAN={'🧭 Kompass':'s6','🤵 John':'s6'};
...
/* Einmalige Nachruestung 27.08.2026: bestehende Layouts (Dock schon gespeichert,
   ...
   geschoben. Danach entscheidet wieder nur Bene: zieht er sie raus oder blendet
...
function start(){
  ...
  beobachten();
  anwenden();
  /* Beim allerersten Start liegen Kompass und John oben — einmal gespeichert,
     danach entscheidet nur noch, was Bene selbst geschoben hat. */
