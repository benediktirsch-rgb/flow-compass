/* ==========================================================================
   ...
   DREI ANSICHTEN (Benes Zusatz vom 06.09.):
     ◎ Einfach        die drei Standard-Einstiege (Mein Board · Heute im Blick · John)
...
/* Aufruf und sichtbare Verweildauer — wie besuch() im Lean-Prototyp der Website, damit der
   Compass in kennzahlen.html mit Aufrufen und Dauer neben /vishnu-lean/ steht und Bene beide
...
/* Standard-Trio: Mein Board · Heute im Blick · John — fehlt eines, rückt das nächste aus dem Katalog nach */
...
/* ---- Assistent: „Wie möchtest du deinen Compass sehen?“ ------------------
   ...
   Ritual, Einrichtungs-Assistent und John gehen vor. */
function wizardEl(){
