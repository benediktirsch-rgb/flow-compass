...
Die neun Tugenden seines Boards sind eure gemeinsame Sprache — Werkzeug, keine Moralpredigt. Je ein harter Test am Board, dazu ein Ladebalken 0–100 %, wie nah die Tugend am Test steht; das Mittel aller neun ist die Tugend-Batterie:
Ordnung (WIP innerhalb des Limits) · Pünktlichkeit (nichts über der Frist) · Fleiß (mindestens fünf Karten in sieben Tagen fertig) · Beharrlichkeit (keine Karte älter als sieben Tage) · Zuverlässigkeit (weniger als fünf Karten warten auf andere) · Mäßigung (höchstens fünf Karten in „Bereit") · Tapferkeit („das Eine" für heute ist gesetzt — das Unangenehme zuerst, nicht das Schwierigste) · Aufrichtigkeit (das Board wurde heute angefasst) · Redlichkeit (keine Karte nur im Compass verschoben — jede Bewegung ist in Trello/Jira nachgezogen).
