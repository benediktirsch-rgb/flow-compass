...
foreach ($f in 'compass-server.ps1','coach-tools.ps1','coach-mcp.ps1','firmen-daten.ps1','gedaechtnis.ps1','ausgabe.ps1','systembild.ps1','madeleine.ps1','madelene-gemeinsam.ps1','vertretung.ps1','kalender.ps1','README.md') { Write-Lf (Join-Path $stage "paket\$f") (Read-Utf8 (Join-Path $paketQuelle $f)) }
