/* compass-live.js — Live-Schicht des Flow Compass (06.09.2026)
   ...
   Drei Dinge, die die Nutzerin am 06.09. bestellt hat („Hier muss eine Reaktion möglich sein“ —
   ...
   1. „Wartet auf dich“ und „Wartet in Slack“: je Eintrag eine Reaktion — schon erledigt,
      ...
      Browser: die Nutzerin schaut mal lokal, mal auf der eigenen Subdomain, mal am Handy.
...
`;
  ...
  async function reagieren(key,art,bar){
    ...
    if(!res||!res.ok){
      ...
      sag(`Reaktion nicht gespeichert: ${esc((res&&(res.hint||res.error))||'Coach-Server nicht erreichbar')}`,'bad'); return;
    }
