/* ==========================================================================
   Flow Compass — Focus View (06.09.2026, ihren Auftrag)

   „Wir sind zu überladen“ — das sagt die Kritik, und sie meint nicht die Nutzerin,
   ...
   Darum ein ZWEITES FRONTEND im selben Compass, kein Umbau:
     ...
     · Eine Kachel führt entweder auf eine „Bühne“ (genau EINE Karte des
       Compass, z. B. Mein Board oder der Kalender), in ein Ritual, zu Coach
...
var KATALOG=[
  ...
  { id:'heute', ic:'🪷', t:'Heute im Blick', s:'Deine drei Kennzahlen und die Management-Summary', prior:0.8, art:'buehne',
    ...
    sel:'#lotusCard' },
  { id:'john', ic:'🤵', t:'Coach', s:'Coach und Sparringspartner — frag ihn, was heute zählt', prior:0.6, art:'john',
  ...
  { id:'madeleine', ic:'👩‍💼', t:'Madeleine', s:'Finanzen, Steuern, Organisation — und die Beraterrunde mit Coach', prior:0.4, art:'john',
...
/* ---- Zähler für die Dashboards (die Nutzerin 06.09.: „wir brauchen Daten zur Entscheidung“) ----
