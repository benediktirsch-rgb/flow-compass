...
(function () {
  ...
  const W = {
    ...
    'Wochenende: aus Trello „die Nutzerin privat“ und Projekt. Antippen streicht eine Sache, fehlt etwas: hier notieren.':
      ['Weekend: from Trello “die Nutzerin privat” and Projekt. Tap to strike something, if anything is missing: note it here.',
       'عطلة نهاية الأسبوع: من Trello „die Nutzerin privat“ ومن فايكونتا. انقر لشطب أمر، وإن نقص شيء فدوّنه هنا.'],
    ...
    'Team und Kunde ruhen bis Montag — {1} Vorgänge in Arbeit warten dort.': ['Team and Kunde rest until Monday — {1} items in progress are waiting there.', 'الفريق والعميل في راحة حتى الاثنين — {1} بنود قيد العمل تنتظر هناك.'],
    'Team und Kunde ruhen bis Montag.': ['Team and Kunde rest until Monday.', 'الفريق والعميل في راحة حتى الاثنين.'],
    ...
    'Tasten: ? alle Tasten · M Morgencheck · A Abendcheck · R Rückfragen · N neue Karte · K Kennzahlen · B Board · J Coach · 0–4 Kontext · ⏎ weiter · Esc schließt':
      ['Keys: ? all keys · M morning check · A evening check · R open questions · N new card · K metrics · B board · J Coach · 0–4 context · ⏎ next · Esc closes',
       'المفاتيح: ? كل المفاتيح · M فحص الصباح · A فحص المساء · R الأسئلة · N بطاقة جديدة · K المؤشرات · B اللوحة · J مدرّب · 0–4 السياق · ⏎ التالي · Esc للإغلاق'],
